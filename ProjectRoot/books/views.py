...
제네릭뷰 중 ListView를 사용하여 리스트 구현
    : ListView를 상속 받는 경우 해당 코델 클래스를 템플릿으로 전달하는 것만으로
